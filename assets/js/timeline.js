...
(function () {
  ...
  function buildList() {
    ...
    toShow.forEach(function (item) {
      ...
      li.className = 'timeline-item ' + side + (item.tag === 'milestone' ? ' is-milestone' : '');
      ...
      li.innerHTML =
        ...
        + '<button class="timeline-details-btn" aria-label="View details for ' + escHtml(item.title) + '">'
        + 'Details'
        + '</button>'
        + '</div>';
      ...
      dot.className = 'timeline-dot' + (item.tag === 'milestone' ? ' milestone-dot' : '');
      li.appendChild(dot);

      var detailsBtn = li.querySelector('.timeline-details-btn');
